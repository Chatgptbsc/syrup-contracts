...
contract StakedSlp {
    ...
    function transferFrom(
        ...
        uint256 nextAllowance = allowances[_sender][msg.sender].sub(
            _amount,
            "StakedSlp: transfer amount exceeds allowance"
        );
    ...
    function _approve(
        ...
        require(
            _owner != address(0),
            "StakedSlp: approve from the zero address"
        );
        require(
            _spender != address(0),
            "StakedSlp: approve to the zero address"
        );
    ...
    function _transfer(
        ...
        require(
            _sender != address(0),
            "StakedSlp: transfer from the zero address"
        );
        require(
            _recipient != address(0),
            "StakedSlp: transfer to the zero address"
        );
